...
| Scale ceiling (writes)                  | ≥ 1.5× etcd / cluster _(Tier 1 target — bar #1)_          | ~50-200K writes/sec / cluster                      | ~10M ops/sec / cluster (mixed)                                | ~10-100M ops/sec / global service (mixed)         |
