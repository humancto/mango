...
- [ ] `crates/mango-storage` skeleton with `redb` + git-pinned `raft-engine` as dependencies (raft-engine compression disabled; lz4_flex above the engine per ADR 0002 §W5)
